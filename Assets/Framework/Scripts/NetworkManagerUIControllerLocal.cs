...
#pragma warning restore 618
    public class NetworkManagerUIControllerLocal : MonoBehaviour
    {
        /// <summary>
        /// The snackbar text.
        /// </summary>
...
#pragma warning restore 618
        ...
        {
            Debug.Log("Created room on: " + LocalIPAddress());


            _manager.matchMaker.CreateMatch(
                 _manager.matchName + ":" + LocalIPAddress(), _manager.matchSize, true, string.Empty, string.Empty,
...
#pragma warning restore 618
        {
            ...
            _manager.networkAddress = host_ip;
