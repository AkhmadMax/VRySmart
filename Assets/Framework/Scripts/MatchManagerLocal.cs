...
public class MatchManagerLocal : MonoBehaviour
{
    ...
    public void OnCreateRoomClicked()
    {
        ...
        manager.matchMaker.CreateMatch(
            manager.matchName + ":" + LocalIPAddress(), manager.matchSize, true, string.Empty, string.Empty,
...
#pragma warning restore 618
    ...
    {
        string host_ip = match.name.Split(':')[1];
        Debug.Log(match.name + " " + host_ip);
        manager.networkAddress = host_ip;
        manager.StartClient();
...
#pragma warning restore 618
    ...
    private void Update()
    {
        ...
        {
            int ping = NetworkManager.singleton.client.GetRTT();
            SnackbarText.text = ping.ToString();
        }
